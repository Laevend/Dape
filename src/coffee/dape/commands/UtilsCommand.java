 ...
 * @author Laeven
 */
@CommandEx(name = "utils",alias = {"u"},description = "A command for utilities")
public final class UtilsCommand extends AstralExecutor
{
	private DecimalFormat scaleFormat = new DecimalFormat("#.###");
	
	public UtilsCommand() throws MissingAnnotationException
	{
		super(UtilsCommand.class);
