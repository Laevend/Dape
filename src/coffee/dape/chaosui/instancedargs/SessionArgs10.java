 ...
 * 
 * A class to denote 10 types of argument being passed into a ChaosGUI for use during an instance.
 * {@link coffee.dape.chaosui.ChaosBuilder#initSessionComponents(SessionArgs10)}
 */
public interface SessionArgs10<A1,A2,A3,A4,A5,A6,A7,A8,A9,A10>
{
	public static final int NUM_OF_ARGS = 10;
	
	/**
	 * Initialise the GUIs instanced components with 10 arguments
	 ...
	 * @param arg9 Argument to pass
	 * @param arg10 Argument to pass
	 */
	void initSession(Player p,A1 arg1,A2 arg2,A3 arg3,A4 arg4,A5 arg5,A6 arg6,A7 arg7,A8 arg8,A9 arg9,A10 arg10);
}
