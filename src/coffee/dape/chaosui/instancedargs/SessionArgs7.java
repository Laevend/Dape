 ...
 * 
 * A class to denote 7 types of argument being passed into a ChaosGUI for use during an instance.
 * {@link coffee.dape.chaosui.ChaosBuilder#initSessionComponents(SessionArgs7)}
 */
public interface SessionArgs7<A1,A2,A3,A4,A5,A6,A7>
{
	public static final int NUM_OF_ARGS = 7;
	
	/**
	 * Initialise the GUIs instanced components with 7 arguments
	 ...
	 */
	void initSession(Player p,A1 arg1,A2 arg2,A3 arg3,A4 arg4,A5 arg5,A6 arg6,A7 arg7);
}
