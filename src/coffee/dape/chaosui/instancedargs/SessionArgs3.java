 ...
 * 
 * A class to denote 3 types of argument being passed into a ChaosGUI for use during an instance.
 * {@link coffee.dape.chaosui.ChaosBuilder#initSessionComponents(SessionArgs3)}
 */
public interface SessionArgs3<A1,A2,A3>
{
	public static final int NUM_OF_ARGS = 3;
	
	/**
	 * Initialise the GUIs instanced components with 3 arguments
	 * @param p Player who owns the session
	 * @param arg1 Argument to pass
	 * @param arg2 Argument to pass
	 * @param arg3 Argument to pass
	 */
	void initSession(Player p,A1 arg1,A2 arg2,A3 arg3);
}
