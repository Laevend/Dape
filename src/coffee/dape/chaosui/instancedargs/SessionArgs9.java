 ...
 * 
 * A class to denote 9 types of argument being passed into a ChaosGUI for use during an instance.
 * {@link coffee.dape.chaosui.ChaosBuilder#initSessionComponents(SessionArgs9)}
 */
public interface SessionArgs9<A1,A2,A3,A4,A5,A6,A7,A8,A9>
{
	public static final int NUM_OF_ARGS = 9;
	
	/**
	 * Initialise the GUIs instanced components with 9 arguments
	 ...
	 */
	void initSession(Player p,A1 arg1,A2 arg2,A3 arg3,A4 arg4,A5 arg5,A6 arg6,A7 arg7,A8 arg8,A9 arg9);
}
