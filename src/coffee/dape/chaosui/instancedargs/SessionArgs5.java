 ...
 * 
 * A class to denote 5 types of argument being passed into a ChaosGUI for use during an instance.
 * {@link coffee.dape.chaosui.ChaosBuilder#initSessionComponents(SessionArgs5)}
 */
public interface SessionArgs5<A1,A2,A3,A4,A5>
{
	public static final int NUM_OF_ARGS = 5;
	
	/**
	 * Initialise the GUIs instanced components with 5 arguments
	 ...
	 */
	void initSession(Player p,A1 arg1,A2 arg2,A3 arg3,A4 arg4,A5 arg5);
}
