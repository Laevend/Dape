...
@NestedChaosGUI(handler = DraftsGuiHandler.class)
public class DraftsGuiBuilder extends ChaosBuilder implements DynamicPaginatorContents
{
	@Override
	public void init()
	{
	...
	{
		return List.copyOf(PlayerDataCtrl.getPlayerData(p).getPostData().getDrafts());
	}
}
