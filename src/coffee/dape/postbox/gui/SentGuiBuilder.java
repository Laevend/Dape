...
@NestedChaosGUI(handler = SentGuiHandler.class)
public class SentGuiBuilder extends ChaosBuilder implements DynamicPaginatorContents
{
	@Override
	public void init()
	{
	...
	{
		return List.copyOf(PlayerDataCtrl.getPlayerData(p).getPostData().getSent());
	}
}
